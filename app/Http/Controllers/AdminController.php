...
class AdminController extends Controller
{
    ...
    {
        $destinationPathThumbnaiils = public_path('/uploads/products/thumbnails');
        ...
        $img->resize(104,104, function ($constraint){
            $constraint->aspectRatio();
        })->save($destinationPathThumbnaiils . '/' . $imagename);
    } 
    ...
    public function coupon_store(Request $request)
    {
        ...
        $coupon->save();
        return redirect()->route('admin.coupons')->with('success', 'Coupons added successfully!');    
    }
