            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route ('admin.categories.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Category Slug" name="slug" tabindex="0" value="{{$categories->slug}}" aria-required="true" required="">
                    </fieldset>
                    @error('slug')
                        <span class="alert alert-danger text-center"{{ $message }}></span>
                    @enderror
                        ...
                        <div class="upload-image flex-grow">
                            @if($categories->image)
                                <div class="item" id="imgpreview">
                                    <img id="previewImage" src="{{ asset('uploads/categories/' . $categories->image) }}" class="effect8" alt="Image Preview">
                                </div>
                            @endif
